...
namespace eastsussexgovuk.webservices.FormControls
{
	...
	public class DataProtectionNotice : System.Web.UI.WebControls.WebControl
	{
		...
		/// </summary>
		public DataProtectionNotice() : base("p")
		{
		}
		...
		protected override void CreateChildControls()
		{
            ...
            this.Controls.Add(new LiteralControl(TextUtilities.ResourceString(typeof(EsccWebTeam_FormControls).Name, "DataProtectionText", EsccWebTeam_FormControls.DataProtectionText)));
