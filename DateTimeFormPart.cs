...
using eastsussexgovuk.webservices.TextXhtml;
...
namespace eastsussexgovuk.webservices.FormControls
{
	...
	public class DateTimeFormPart : System.Web.UI.WebControls.WebControl
	{
		...
		public DateTimeFormPart(string label) : base(HtmlTextWriterTag.Fieldset)
		{
			// set style
			...
			vcDayReqMonthYear.ErrorMessage = TextUtilities.ResourceString(resourceFileName, "DateRequiresMoreThanDayError", EsccWebTeam_FormControls.DateRequiresMoreThanDayError);
			...
			vcMonthReqDayYear.ErrorMessage = TextUtilities.ResourceString(resourceFileName, "DateRequiresMoreThanMonthError", EsccWebTeam_FormControls.DateRequiresMoreThanMonthError);
            ...
            vcYearReqDayMonth.ErrorMessage = TextUtilities.ResourceString(resourceFileName, "DateRequiresMoreThanMonthError", EsccWebTeam_FormControls.DateRequiresMoreThanMonthError);
		...
		public DateTimeFormPart(string label, string questionId, string questionRef, bool required, string lblcss, string ctrlcss ) : base(HtmlTextWriterTag.Fieldset)
		{
			// set style
			this.CssClass = this.partCss;
